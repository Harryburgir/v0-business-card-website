                      ...
                      <td>
                        ...
                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background: #faf8f5; padding: 20px;">
                          <tr>
                            ...
                            <td style="padding: 4px 0; font-size: 14px; color: #2c2825;">${name}</td>
                          </tr>
                          <tr>
                          ...
                          ${phone ? `<tr>
                            ...
                            <td style="padding: 4px 0; font-size: 14px; color: #2c2825;">${phone}</td>
                          </tr>` : ""}
                          <tr>
                            <td style="padding: 4px 0; font-size: 14px; color: #5c574f;">Adres</td>
                            <td style="padding: 4px 0; font-size: 14px; color: #2c2825;">${address}</td>
                          </tr>
                          ${notes ? `<tr>
                            <td style="padding: 4px 0; font-size: 14px; color: #5c574f;">Uwagi</td>
                            <td style="padding: 4px 0; font-size: 14px; color: #2c2825;">${notes}</td>
                          </tr>` : ""}
                        </table>
                      </td>
                    </tr>
