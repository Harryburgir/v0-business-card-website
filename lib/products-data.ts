...
export const categories: Category[] = [
  ...
  },
  {
    ...
    longDescription: "Starannie dobrane zestawy ubranek, które idealnie ze sobą współgrają. Każdy komplet to gotowa stylizacja dla Twojego maluszka.",
    products: [
      {
        id: "komplet-1",
        title: "Komplet body + śpiochy",
        price: "139 zł",
        image: "/images/product-komplet-1.jpg",
        description: "Klasyczne połączenie",
        sizes: ["56", "62", "68", "74"],
      },
      {
        id: "komplet-2",
        title: "Komplet 3-częściowy",
        price: "189 zł",
        image: "/images/product-komplet-2.jpg",
        description: "Body, spodnie, czapeczka",
        sizes: ["56", "62", "68"],
      },
    ],
  },
