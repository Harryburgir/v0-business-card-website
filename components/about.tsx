...
export function About() {
  ...
  return (
    <section id="o-nas">
      ...
      {/* ── Hero zdjęcie z tekstem na wierzchu ── */}
      <div className="relative min-h-[70vh] flex items-center overflow-hidden">
        <Image
          src="/images/about-hero.jpg"
          alt="Noworodki w białych śpiworkach — La de Bébé mini"
          fill
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 py-24 lg:py-32 w-full">
          <div className="max-w-2xl">
            ...
            <button
              ...
              className="mt-10 inline-flex items-center gap-2 self-start border border-white/40 bg-white/10 backdrop-blur-sm px-6 py-3 text-sm font-medium uppercase tracking-[0.15em] text-white transition-all hover:bg-white/20 hover:border-white/60"
            >
      ...
      {/* ── Trzy filary ── */}
      <div className="bg-warm/40 px-6 py-16">
      ...
      {/* ── Kolaboracja z Olą Tomalą (rozwijana) ── */}
      <div
