  ...
  return (
    <section id="o-nas" className="bg-warm/40 px-6 py-24 lg:py-32">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <div className="flex flex-col justify-center">
            ...
            <button
              ...
              className="mt-8 inline-flex items-center gap-2 self-start border border-primary/30 bg-primary/5 px-6 py-3 text-sm font-medium uppercase tracking-[0.15em] text-primary transition-all hover:bg-primary/10 hover:border-primary/50"
            >
        ...
        {/* ── Wiersz 2: Kolaboracja z Olą Tomalą (ukryta/rozwijana) ── */}
        <div
          className={`grid transition-all duration-500 ease-in-out overflow-hidden ${
            showCollab ? "grid-rows-[1fr] opacity-100 mt-20" : "grid-rows-[0fr] opacity-0 mt-0"
          }`}
        >
